			...
			<div class="col-md-8">
				...
				<div>
					<ul class="list-group">
						...
						<li class="list-group-item"><input id="birth"
							name="mem_birth" type="text" placeholder="생년월일 "
							class="form-control input-md" required="required"></li>
						<li class="list-group-item"><input id="phone"
							name="mem_phone" type="text" placeholder="전화번호"
							class="form-control input-md" required="required"> <span
							id=phoneresult></span></li>

						<li class="list-group-item"><input id="mail" name="mem_email"
							type="text" placeholder="이메일" class="form-control input-md"
							required="required"> <input id="mailchk" type="text"
							placeholder="인증번호" class="form-control input-md"
							required="required"> <input type="button"
							class="btn btn-theme" id="numberchk" value="인증번호받기"> <input
							type="button" class="btn btn-theme" id="write" value="입력하기">
							<span id="emailresult"></span></li>
						...
						<li class="list-group-item"><input id="mem_zipcode"
							...
							id="mem_addr_detail" name="mem_addr_detail" type="text"
							placeholder="상세주소" class="form-control input-md"></li>
						...
						<li class="list-group-item"><select class="form-control"
							name="mem_bank_code" id="bank_code">
								<option value="001">국민은행</option>
								<option value="002">우리은행</option>
								<option value="003">신한은행</option>
						</select> <input id="account" name="mem_account" type="text"
							placeholder="계좌번호" class="form-control input-md"
							required="required"> <input type="button"
							class="btn btn-theme" id="account_btn" value="인증조회"></li>

						<li class="list-group-item"><input type="checkbox"
							id="agree1"> 이용약관동의 <span> </span> <input type="button"
							class="btn btn-theme" value="내용보기" /></li>
						<li class="list-group-item"><input type="checkbox"
							id="agree2"> 개인정보 수집 및 이용동의 <span> </span> <input
							type="button" class="btn btn-theme" value="내용보기" /></li>
						<li class="list-group-item"><input type="checkbox"
							id="agree3"> 우편번호와 주소 수집 및 이용 동의 <span></span></li>
