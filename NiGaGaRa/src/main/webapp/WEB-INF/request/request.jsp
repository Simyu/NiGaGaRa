			...
			<div class="col-md-6 panel-body container">
				...
				<div class="form-group">
					<input type="text" name="name" class="form-control" id="start"
						placeholder="출발지" data-rule="minlen:4"
						data-msg="Please enter at least 4 chars" />
					<div class="validation"></div>
				</div>
				<div class="form-group">
					<input type="text" name="name" class="form-control" id="end"
						placeholder="도착지" data-rule="minlen:4"
						data-msg="Please enter at least 4 chars" />
					<div class="validation"></div>
				</div>
				<div class="text-center">
					<button type="submit" class="btn btn-theme">경로확인</button>
				</div>
			</div>
			<div class="col-md-6 panel-body container">
				<div class="row">
					...
					<form action="" method="post" role="form" class="contactForm">
						<div class="form-group">
							<input type="text" name="name" class="form-control" id="getter"
								placeholder="수령인" data-rule="minlen:4"
								data-msg="Please enter at least 4 chars" />
							<div class="validation"></div>
						</div>
						<div class="form-group">
							<input type="text" name="name" class="form-control"
								id="getterPhoneNum" placeholder="수령인 전화번호" data-rule="minlen:4"
								data-msg="Please enter at least 4 chars" />
							<div class="validation"></div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<select name="name" class="form-control" id="goodsType"
								data-msg="Please enter at least 4 chars">
						...
						<div class="form-group">
							<input type="text" name="name" class="form-control" id="weight"
								placeholder="상품 무게" data-rule="minlen:4"
								data-msg="Please enter at least 4 chars" />
							<div class="validation"></div>
						</div>
						<div class="form-group">
							<input type="text" name="name" class="form-control" id="quantity"
								placeholder="상품 수량" data-rule="minlen:4"
								data-msg="Please enter at least 4 chars" />
							<div class="validation"></div>
						</div>
						<div class="form-group">
