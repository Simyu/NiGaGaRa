...
<div class="pay_btn">
<form action="/NiGaGaRa/payment_forth.do" method="post" role="form" class="contactForm">
<input type="hidden" name ="mem_id" value="${loginUser.mem_id }">
<input type="text" class="btn_pay btn_pay_hover" placeholder="전환할 금액입력" name="cash"/>
<button type="submit" class="btn_pay btn_pay_hover">
결제
</button>
</form>
</div>
